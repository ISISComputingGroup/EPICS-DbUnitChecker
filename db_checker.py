...
allowed_prefixable_units = {'A', 'angstrom', 'bar', 'B', 'bit', 'byte', 'C', 'count', 'degree', 'eV', 'G', 'frame',
...
class TestPVUnits(unittest.TestCase):
    ...
    @ignore(["channel_aliases.db"], "Mutually exclusive guards prevent this from ever happening")
